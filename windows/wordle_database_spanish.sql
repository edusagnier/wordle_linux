...
('dos'),('feo'),('ano'),('dar'),('ray'),('sol'),('uni'),('fue'),('soy'),('zoo'),('mal'),('soy'),('sol'),
('ida'),('dio'),('fea'),('dar'),('ser'),('dia'),('dos'),('sol'),('mar'),('sal'),('hoy'),('cal'),('par'),
('rey'),('rey'),('ser'),('uva'),('oro'),('pan'),('fue'),('rey'),('mes'),('luz'),('mes'),('feo'),('ves'),
('dio'),('era'),('rey'),('son'),('dio'),('sol'),('yog'),('mes'),('dos'),('mal'),('ano'),('vos'),('mes'),
('sol'),('mil'),('vas'),('vez'),('luz'),('sol'),('vez'),('dia'),('dio'),('ves'),('uni'),('mas'),('son'),
...
CREATE TABLE wordle.palabras4 (
    ...
    palabra4 VARCHAR(5) NOT NULL
);
INSERT INTO wordle.palabras4 (palabra4)
VALUES
('sola'),('mesa'),('mora'),('malo'),('pana'),('piel'),('loco'),('puas'),('vino'),('pedo'),('puro'),('pino'),
('bien'),('iran'),('cafe'),('fino'),('pavo'),('solo'),('cien'),('nuez'),('muro'),('auto'),('bufo'),('rino'),
('pozo'),('sano'),('zeta'),('vara'),('duna'),('coco'),('tina'),('lona'),('mudo'),('duro'),('anos'),('alma'),
('lomo'),('dios'),('roca'),('miga'),('pila'),('ruin'),('judo'),('burl'),('sera'),('lote'),('suda'),('feto'),
('seda'),('dedo'),('cero'),('vaso'),('buho'),('zumo'),('elmo'),('loco'),('fosa'),('vino'),('moho'),('cuna'),
('ruin'),('sera'),('numo'),('cito'),('coco'),('sano'),('zulo'),('puño'),('romo'),('auto'),('ceno'),('faro'),
